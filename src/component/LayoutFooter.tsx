import { Arrow_Up, FaceBook, Instagram, logo_jewelry, Twitter } from "../utils/consts";
...
const LayoutFooter = () => {
    return (
        <div className="relative">
            ...
            <div className="px-12 max-sm:px-6 text-gray-600 font-medium">
                <div className="h-2 border-b-4 "></div>
                <p className="py-6 text-center">© 2023 Copyright. All Rights Reserved.</p>
            </div>
            <div className="fixed bottom-8 right-8 max-sm:bottom-4 max-sm:right-4 bg-[#F5CC61] rounded-full p-2 max-sm:p-0">
